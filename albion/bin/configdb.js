...
create table city (id integer not null auto_increment primary key,name varchar(60) not null);
...
insert into city(name) values ("Bridgewatch");
insert into city(name) values ("Carleon");
insert into city(name) values ("Martlock");
insert into city(name) values ("Thetford");
insert into city(name) values ("Lymhurst");`;
